 ...
 * @param[out] out_mem_usage Non-NULL pointer to store the memory requirement in
 * bytes.
 *
 ...
 * @param[in] options Pointer to the compression options.
 * @param[out] out_size Pointer to store the output file size in bytes. Pass
 ...
 * @param[out] out_total_bytes Pointer to store the total generated bytes. Pass
 * `NULL` to omit this output.
 *
 * @retval XZRA_SUCCESS On success.
