 ...
 * @author Generated by Claude Opus 4.6 + Gemini 3.1 Pro
...
// ======================== Int64HashMapInitAllocator ========================

TEST(Int64HashMapTest, InitializesWithAllocator) {
    ...
    Int64HashMap map;
    Int64HashMapInitAllocator(&map, 0.5, allocator);
...
TEST(Int64HashMapTest, ExpansionFailsWhenAllocatorMemoryExhausted) {
    GamesmanAllocatorOptions options;
    GamesmanAllocatorOptionsSetDefaults(&options);
    ...
    // Initial insertions should succeed (depending on the initial capacity)
    // Eventually it should fail to expand and return false.
    bool expansion_failed = false;
    for (int64_t i = 0; i < 50; ++i) {
        if (!Int64HashMapSet(&map, i, i * 10)) {
